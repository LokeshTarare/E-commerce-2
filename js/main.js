...
/*=============== QUESTIONS ACCORDION ===============*/
const accordionItem = document.querySelectorAll('.questions_items');

accordionItem.forEach((items) => {
    const accordionHeader = items.querySelector('.questions_header')
...
const toogleItem = (items) => {
    const accordionContent = items.querySelector('.questions_content')
